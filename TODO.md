...
6. [ ] **에이전트 프레임워크를 학습 순서대로 익힌다** — Function Calling → LangChain Agent → LangGraph → Agentic RAG 직접 구현 → Multi-Agent → 프레임워크 비교. 상세 계획은 [에이전트 프레임워크 학습 로드맵](docs/learning-roadmaps/agent-framework-study-roadmap.md).
